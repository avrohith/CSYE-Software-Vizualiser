...
function Level()
{
    ...
    */
    this.startupLevel = function(canvasWidth, canvasHeight)
    {
        ...
        this.powerups['1'] = 'RedGem';
        this.powerups['6'] = 'GreenGem';
        this.powerups['10'] = 'GreenGem';
        this.powerups['14'] = 'RedGem';
    ...
    */
    this.addBlocks = function(canvasWidth, canvasHeight)
    {
        for (var x = 0; x < this.blocks.length; ++x)
        {
            ...
            {
                new VisualGameObject().startupVisualGameObject(g_block, x * this.blockWidth, canvasHeight - (y + 1) * this.blockHeight, 4);
            }
        }
    }
        ...
        for (var x = 0; x < this.blocks.length; ++x)
        {
            if (this.powerups[x])
            {
                ...
                switch(this.powerups[x])
                 {
                    case 'RedGem':
                        new Powerup().startupPowerup(5, g_gem, xPosition - g_gem.width / 2, yPosition - g_gem.height, 4, 1, 1);
                        break;
                    case 'GreenGem':
                        new Powerup().startupPowerup(15, green_gem, xPosition - green_gem.width / 2, yPosition - green_gem.height,4, 1, 1);
                        break;
                 }
            }
        }
