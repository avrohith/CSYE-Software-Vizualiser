...
function Player()
{
    ...
    */
    ...
    {
        this.startupAnimatedGameObject(g_idle_left, 300, 400 - 48 - 48, 4, 6, 20);
        this.level = level;
        return this;
    }
    ...
    */
    this.updateAnimation = function()
    {
       ...
       this.setAnimation(g_idle_left, 6, 20);
       else if (this.right && !this.grounded)
       this.setAnimation(g_idle_right, 6, 20);
       else if (this.left && !this.grounded)
       this.setAnimation(g_idle_left, 6, 20);
       else if (this.right && this.grounded)
    ...
    */
	this.update = function (/**Number*/ dt, /**CanvasRenderingContext2D*/context, /**Number*/ xScroll, /**Number*/ yScroll)
    {
        ...
        if (this.x > context.canvas.width - this.frameWidth + xScroll -  this.screenBorder)
           g_GameObjectManager.xScroll = 2 * (this.x - (context.canvas.width - this.frameWidth -  this.screenBorder));
        ...
        // left side
        var currentBlock1 = this.level.currentBlock(this.x + this.framewidth/2);
        // right side
        var currentBlock2 = this.level.currentBlock(this.x + this.frameWidth/2);
