...
$.fn.themeswitcher = function(settings){
	...
	//markup 
	var button = $('<a href="#" class="jquery-ui-themeswitcher-trigger"><span class="jquery-ui-themeswitcher-icon"></span><span class="jquery-ui-themeswitcher-title">'+ '' +'</span></a>');
	...
	$.fn.spShow = function(){ $(this).css({top: button.offset().top + options.buttonHeight + 0, left: button.offset().left}).slideDown(50); button.css(button_active); options.onOpen(); }
